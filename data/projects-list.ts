...
export const projectsList = [
  {
    ...
    link: 'https://casarustica.be',
    desc: `Casa Rustica is a website for a beach house at the belgian sea side. Potential clients can see some pictures of the house and find the availabilities for a certain date.`,
    technologies: ['Nextjs', 'React', 'TypeScript', 'Docker', 'Prisma', 'Google API', 'postgress']
  },
  {
    id: 2,
    title: 'Notch',
